...
You can use these little helper functions to write **automatic exercise grading** to Pluto notebooks. These checks run while students work on their homework, giving instant feedback while they are working on a solution.

To see this in action, take a look at the section **"Guided assignments"** in [the Pluto documentation (Education section)](https://plutojl.org/en/docs/education/#Guided-assignments).

!!! info "Not for autograding"
	These boxes don't help with automatically checking `.jl` notebook file submissions and grading automatically. Ask the Julia discourse or Pluto zulip to learn more about this.
"""

# ╔═╡ 3eb5bc16-40f7-433e-a5fc-7613068a1e03
md"""
## How to use these boxes
You can write your exercise in 4 parts:
1. The problem statement
2. A function definition, with `missing` as the placeholder content. Students will write their solution here
3. One or two testing invocations of the function. This lets students test their function while writing.
4. A hidden cell with automatic answer checking (using the blocks below).

Because of Pluto's reactivity, 3 and 4 will automatically re-run when the student updates 2! Let's see this in action.
"""

# ╔═╡ 203cd7f2-5787-42c0-8fb5-1a5b5844edf4


# ╔═╡ 7a0154a8-ded9-4171-92e8-c42cad570721


# ╔═╡ 6c3e8592-d76e-4c15-87d5-6e4aa6e7e8bc
md"""
**👉 Exercise:** Write a function that finds the smallest number in a vector.
"""

# ╔═╡ ff6acd6d-d884-4d07-878a-ee20072a0826
function smallest_number(xs::Vector{<:Real})
	# Write your answer here!
	return missing
end

# ╔═╡ cc068178-9bc1-4ce4-9bd3-c03900d7ff8f
smallest_number([5,4,2000,30])

# ╔═╡ 4c67f56a-f9ff-4eba-9083-0c70d10ce09b
smallest_number([5])

# ╔═╡ 480dd2a0-8b37-42fa-855e-cd00fe50e1bb
let
	test_result = smallest_number([99, 100, 101, 2000, 12])
	if ismissing(test_result)
		still_missing()
	elseif test_result == 2000
		almost(md"Whoops, you got the biggest number, not the smallest")
	elseif test_result == 12
		correct()
	else
		keep_working()
	end
...
md"""
*Note: Normally, the code is hidden for the cell above!*
"""
